export const messages = {
    ...
    success: {
        ...
        clienteCreated: "Cliente criado com sucesso",
        clienteUpdated: "Cliente atualizado com sucesso",
        clienteDeleted: "Cliente removido com sucesso",
        vendaCreated: "Venda criada com sucesso",
        vendaUpdated: "Venda atualizada com sucesso",
        vendaDeleted: "Venda removida com sucesso",
        usuarioCreated: "Usuário criado com sucesso",
        usuarioUpdated: "Usuário atualizado com sucesso",
        usuarioDeleted: "Usuário removido com sucesso",
        itemCreated: "Item criado com sucesso",
        itemUpdated: "Item atualizado com sucesso",
        itemDeleted: "Item removido com sucesso"
    },
    ...
    error: {
        ...
        noEditPermission: (fieldName) => `Você não tem permissão para editar outros ${fieldName}.`,
        editPermissionDepartment: (fieldName) => `Você não tem permissão para editar ${fieldName} de outras secretarias.`,
        clienteNotFound: "Cliente não encontrado com o ID informado",
        vendaNotFound: "Venda não encontrada com o ID informado",
        usuarioNotFound: "Usuário não encontrado com o ID informado",
        itemNotFound: "Item não encontrado com o ID informado"
    },
    ...
    customValidation: {
        ...
        invalidApiKeyName: {message: "O nome da chave de API só pode conter letras, números e traços"},

        invalidData: (fieldName) => {
            return { message: `Valor em ${fieldName} não é uma data válida ou está no futuro` };
        },
